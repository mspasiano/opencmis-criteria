...
public class Restrictions {
     ...
     * @param value        value compared with property
     ...
     * @param propertyName property to compare
     * @param value        value compared with property
     * @param matchMode    match mode in comparision
     * @return LIKE expression
     */
     ...
     *
     * @param propertyName property to compare
     * @param low          low between boundary
     * @param high         high between boundary
     ...
     *
     * @param propertyName property to compare
     * @param values       values compared with property
