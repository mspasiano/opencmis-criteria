 ...
 *
 * $Id: LogicalExpressionOperator.java 1 2010-12-09 11:44:57Z marco.spasiano $
 */

/**
 * Represents logical expression operator.
 *
...
enum LogicalExpressionOperator implements Operator
{
     ...
     * (non-Javadoc)
     *
     * @see it.spasia.opencmis.criteria.restrictions.Operator#getStringRepresentation()
     */
